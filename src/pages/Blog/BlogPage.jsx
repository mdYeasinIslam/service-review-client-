...
export default function BlogPage() {
  ...
  return (
    <div
      className=" bg-black/50 text-neutral-100"
          ...
          <div className=" mx-auto py-8 md:py-24">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-5">
                Stories from the
                <br />
                <span className="text-amber-400">World&lsquo;s Edge</span>
              </h1>
              <p className="text-neutral-400 text-lg leading-relaxed mb-8">
                Real travel. Honest guides. Destinations you haven&lsquo;t seen
                on a postcard yet. Written by travellers who live out of a bag.
              </p>
              {/* Search */}
